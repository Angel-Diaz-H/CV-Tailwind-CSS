export const Capacitaciones = () => {
  return (
    <div>
      ...
      2025. Jetro Systemic | DE. 102. Aplicando FODA. Agosto 2025. Jetro
      Systemic | DE. 103. Abordando Riesgos y Oportunidades. Agosto 2025.
      Desitel Centro de Capacitaciones | Data Analytics with POWER BI. Mayo
      2025.
    </div>
  );
};
